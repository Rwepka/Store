<template>
  <div class="slider__container">
    ...
    <div class="slider__box"><input @input="onChangeFirst()" min="0.95" max="300" class="slider" value="0.95" type="range"></div>
    <div class="slider__box"><input @input="onChangeSecond()" min="0.95" max="300" class="slider second" value="250" type="range"></div>
  ...
  export default defineComponent({
    data(){
      return {
        firstSliderValue: 0.95,
        secondSliderValue: 250
      }
    },
    methods: {
      onChangeFirst(){
